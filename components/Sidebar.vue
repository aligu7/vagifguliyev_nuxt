<template>
  <div id="tooplate_sidebar">
    ...
    <div id="tooplate_menu">
      <ul>
        <li>
          <NuxtLink to="/" class="home"><span></span>Home</NuxtLink>
        </li>
        <li>
        ...
        <li>
          <NuxtLink to="/press" class="about"><span></span>Press</NuxtLink>
        </li>
        <li>
          <NuxtLink to="/contact" class="about"><span></span>Contact</NuxtLink>
        </li>
      </ul>
    ...
    <div id="twitter">
      ...
      <p>
        Copyright © 2019 <a href="http://www.guliyev.com">GULIYEV.COM</a> <br />
        by <a href="http://www.guliyev.com" target="_parent">A Team</a>
      </p>
    </div>
  </div>
</template>
