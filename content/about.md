...
areaOfInterest:
  [
    { text: "Potential type operators on Lie groups or homogeneous spaces", bold: false },
    { text: "Singular integral operators on Lie groups or homogeneous spaces", bold: true },
    { text: "Function spaces on Lie groups or homogeneous spaces", bold: false },
    { text: "Banach-valued Function spaces of fractional smoothness", bold: true },
    { text: "Integral operators on strictly pseudo-convex domains in Cn", bold: false },
    { text: "Function spaces on strictly pseudo-convex domains in Cn", bold: true },
    {
      text:
    ...
    {
      text:
        "Singular integrals, maximal functions and other integral operators, generated by Bessel
  ...
  [
    {
      ...
      description:
        ["Professor", "Doctor of Sciences", "Correspondence Member of Russian Academy of Sciences"],
      pdfEn: null,
    ...
    },
    {
      ...
      description: ["Professor", "Doctor of Sciences", "Professor of Cardiff University"],
